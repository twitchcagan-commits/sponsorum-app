export default function PaymentsPage() {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center gap-4 text-center px-4">
      ...
      <h1 className="text-2xl font-extrabold" style={{ color: "#042C53" }}>Ödemeler</h1>
      <p className="text-gray-500 max-w-sm">Ödeme geçmişi ve escrow yönetimi yakında burada olacak.</p>
