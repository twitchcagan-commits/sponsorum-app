  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "linear-gradient(135deg, #E6F1FB 0%, #ffffff 60%)" }}>
      ...
      <main className="flex-1 flex flex-col items-center justify-center gap-6 text-center px-4 py-20">
        ...
        <div>
          <h1 className="text-3xl font-extrabold mb-3" style={{ color: "#042C53" }}>Ödemeler</h1>
          <p className="text-gray-500 max-w-sm leading-relaxed">
            Escrow&apos;daki ödemeleri, fatura geçmişini ve bekleyen işlemleri görüntüleyeceğin panel yakında burada.
          </p>
        </div>
        <a
          href="/dashboard"
